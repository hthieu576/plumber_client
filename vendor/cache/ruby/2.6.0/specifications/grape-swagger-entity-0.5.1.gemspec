# -*- encoding: utf-8 -*-
# stub: grape-swagger-entity 0.5.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<grape-entity>.freeze, [">= 0.6.0"])
    s.add_runtime_dependency(%q<grape-swagger>.freeze, [">= 1.2.0"])
  else
    s.add_dependency(%q<grape-entity>.freeze, [">= 0.6.0"])
    s.add_dependency(%q<grape-swagger>.freeze, [">= 1.2.0"])
  end
end
