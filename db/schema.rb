...
ActiveRecord::Schema.define(version: 2022_10_25_110109) do
  ...
  create_table "jobs", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.index ["plumber_id"], name: "index_jobs_on_plumber_id"
  end

  create_table "plumbers", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "name"
    t.string "address"
    t.integer "vehicles"
    t.datetime "created_at", null: false
